...
class StructProgrammer(Programmer):
    ...
    def __init__(self, *args):
        ...
        self.match_row_slot_1 = nn.Linear(self.rnn_hidden_size * 4 + self.op_embed_size + \
            self.var_token_embed_size + self.column_type_embed_size + self.column_indicator_size,
            self.slot_hidden_score_size)
        ...
        self.match_col_slot_1 = nn.Linear(self.var_token_embed_size + self.column_type_embed_size + 
