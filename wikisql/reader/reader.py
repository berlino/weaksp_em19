...
from wikisql.reader.util import load_jsonl, load_jsonl_table
from allennlp.data import Vocabulary
import pdb

arg_parser = argparse.ArgumentParser(description="WikiSQL dataset reader.")
...
arg_parser.add_argument('-output_filename', help="file path of output file")
...
class WSReader():
    ...
    def gen_vocab(self):
        ...
        self.vocab = Vocabulary(counter={"tokens":counter}, min_count={"tokens":3}, 
                    max_vocab_size={"tokens":60000}, pretrained_files={"tokens":self.embed_file}, 
...
if __name__ == "__main__":
    ...
    wt_reader = WSReader(tables, train_examples, dev_examples, test_examples, args.embed_file)
    wt_reader.gen_vocab()
    wt_reader.gen_glove()
