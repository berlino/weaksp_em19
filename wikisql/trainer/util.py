...
def create_opt(parameters, opt, lr, l2):
    if opt == "SGD":
        optimizer = optim.SGD(parameters, lr=lr, weight_decay=l2)
    elif opt == "Adam":
        optimizer = optim.Adam(parameters, lr=lr, weight_decay=l2)
    elif opt == "Adagrad":
        optimizer = optim.Adagrad(parameters, lr=lr, weight_decay=l2)
    # scheduler = optim.lr_scheduler.StepLR(optimizer, step_size=6, gamma=0.1)
    scheduler = optim.lr_scheduler.MultiStepLR(optimizer, milestones=[6, 14], gamma=0.1)
